            ...
            <div class="about__bottom">
                <div class="about__bottom-left">
                    ...
                    <div class="about__bottom-button animate__animated">
                        <a class="about__bottom-button-link" href="https://vk.com/club222694143" target="_blank">Перейти в группу ВК</a>
                    </div>
                </div>
                <div class="wrap-5">
    ...
    <section id="portfolio">
        <div class="containers portfolio">
            ...
            <div class="portfolio__button">
                <a href="https://vk.com/club222694143" target="_blank">Больше фото</a>
            </div>
        </div>
    </section>
    <section id="banner">
        ...
        <div class="containers footer">
            <div class="footer__contacts">
                ...
                <div class="footer__contacts-social">
                    <a href="https://vk.com/club222694143" target="_blank"><img src="{{ asset('assets/img/vk.svg') }}" /></a>
                    <a href="https://t.me/+2R7ZvZ7vaitjYjli" target="_blank"><img src="{{ asset('assets/img/tg.svg') }}" /></a>
                    <a href="https://ok.ru/group/70000003693762" target="_blank"><img src="{{ asset('assets/img/ok.svg') }}" /></a>
                </div>
